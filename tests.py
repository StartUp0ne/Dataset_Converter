import unittest
from dataset_parser import convert_bert_to_spacy, read_bert_file_split_into_texts, parse_spacy_to_bert_format, \
    read_bert_file_one_line
...
class ParseSpacyToBertTestCase(unittest.TestCase):
    def test_spacy_to_bert(self):
        ...
        expected_dataset = read_bert_file_split_into_texts(expect_file)
        ...
        result_dataset = read_bert_file_split_into_texts(res_file)
...
class ParseBertToSpacyTestCase(unittest.TestCase):
    def test_bert_to_spacy_one_text(self):
        test_data = read_bert_file_one_line(r"C:\Users\tropi\OneDrive\Desktop\RoadmapPython_5_Files\test_files\bert_to_spacy_test.txt")
        expected_dataset = [
            {'id': 0,
             'text': ' Compromise indicators name md5 sha256 Cobalt Strike MD5_TOKEN '
                     ...
                     'SHA256_TOKEN ',
             'label': [[39, 52, 'MALWARE_NAME'], [53, 62, 'IOC_MD5'], [63, 75, 'IOC_SHA256'], [76, 80, 'MALWARE_NAME'],
                       [81, 90, 'IOC_MD5'], [91, 103, 'IOC_SHA256'], [104, 115, 'MALWARE_NAME'], [116, 125, 'IOC_MD5'],
                       [126, 138, 'IOC_SHA256']]
             }
        ]
    ...
    def test_bert_to_spacy_split_texts(self):
        test_data = read_bert_file_split_into_texts(
